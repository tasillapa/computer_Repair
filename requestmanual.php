    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2><!-- InstanceBeginEditable name="EditRegion4" -->รายการซ่อมอาการเบื้องต้น<!-- InstanceEndEditable --></h2>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    $sql = "select * from tb_requestfix as fix left join tb_department as dep on dep.departid=fix.departid where fixcase=1003  and fixstatus='0' order by reportdate asc";
