    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2><!-- InstanceBeginEditable name="EditRegion4" -->รายการส่งศูนย์<!-- InstanceEndEditable --></h2>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table dataTable js-exportable">
                                    ...
                                    <?php 	$connect = new management;$connect->con_db();
											$sql = "select * from tb_requestfix as fix left join tb_department as dep on dep.departid=fix.departid where fixcase=1004  and fixstatus='0' order by reportdate asc";
