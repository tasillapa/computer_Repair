    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2><!-- InstanceBeginEditable name="EditRegion4" -->แจ้งซ่อมคอมพิวเตอร์<!-- InstanceEndEditable --></h2>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table dataTable js-exportable">
                                    ...
                                    <?php 	$connect = new management;$connect->con_db();
											$sql = "select * from tb_requestfix as fix left join tb_department as dep on dep.departid=fix.departid  where fixstatus='0' order by reportdate asc";
									...
									?>
                                        <tr>
                                            ...
                                            <td><i class="material-icons" data-toggle="modal" data-target="#defaultModal" onClick="Javascript:func_loaddataforupdate('LOADDATAFIX','<?php echo $rs['fixid']?>')" style="cursor:pointer;">settings_applications</i></td>
                                        </tr>
                                    <?php $intcount++; } ?>
                                    </tbody>
                                </table>
